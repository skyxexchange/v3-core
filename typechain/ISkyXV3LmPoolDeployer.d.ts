...
interface ISkyXV3LmPoolDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class ISkyXV3LmPoolDeployer extends Contract {
  ...
  interface: ISkyXV3LmPoolDeployerInterface;
