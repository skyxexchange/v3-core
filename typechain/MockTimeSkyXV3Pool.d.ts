...
interface MockTimeSkyXV3PoolInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    ...
    "SetLmPool(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SetLmPool"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Swap"): EventFragment;
}

export class MockTimeSkyXV3Pool extends Contract {
  ...
  interface: MockTimeSkyXV3PoolInterface;
  ...
  filters: {
    ...
    SetLmPool(lmPool: null): EventFilter;
