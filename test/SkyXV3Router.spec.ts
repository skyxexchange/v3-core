...
describe('SkyXV3Pool', () => {
  ...
  let pool0: MockTimeSkyXV3Pool
  let pool1: MockTimeSkyXV3Pool
  ...
  let swapTargetCallee: TestSkyXV3Callee
  let swapTargetRouter: TestSkyXV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeSkyXV3Pool, any]> => {
